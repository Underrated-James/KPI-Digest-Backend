...
export const PROJECT_RESPONSE_MESSAGES = {
  ...
  HARD_DELETED: 'Project hard deleted successfully',
  RETRIEVED_ALL: 'Projects retrieved successfully',
  RETRIEVED_ONE: 'Project retrieved successfully',
  CREATED: 'Project created successfully',
  PATCHED: 'Project patched successfully',
  PUT: 'Project put successfully',

...
@Injectable()
export class CreateAssignTicketUseCase {
  constructor(
  ...
  async execute(dto: CreateAssignTicketDto | CreateAssignTicketDto[]): Promise<TicketEntity | TicketEntity[]> {
  ...
  private async executeSingle(dto: CreateAssignTicketDto): Promise<TicketEntity> {
  ...
  private async executeBulk(dtos: CreateAssignTicketDto[]): Promise<TicketEntity[]> {
  ...
  private async validateTicket(dto: CreateAssignTicketDto, existingTicket: TicketEntity | null, sprint: any | null, team: any | null): Promise<void> {
    if (existingTicket) {
  ...
  private mapToEntity(dto: CreateAssignTicketDto, team: any | null): TicketEntity {

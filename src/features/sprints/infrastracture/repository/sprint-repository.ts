...
export interface SprintRepository {
  ...
  findAll(status?: SprintStatus, projectId?: string, search?: string): Promise<Sprint[]>;
  findAllPaginated(page: number, size: number, status?: SprintStatus, projectId?: string, search?: string): Promise<PaginatedResult<Sprint>>;
